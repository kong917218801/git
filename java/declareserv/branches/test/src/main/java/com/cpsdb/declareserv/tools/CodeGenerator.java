...
public class CodeGenerator {
    ...
    public final static String hbmXmlPath = "hbm";
    /**
     ...
     */
    public final static String hole_projectDir = "T:\\J2EE\\java\\declareserv\\trunk";
    public final static String basePackage = "com.cpsdb.declareserv";
    public final static String subPackage = "";//子目录，填你想填
    public final static String dbUrl = "jdbc:mysql://192.168.1.61:3306/declareserv";
    /* 数据库database */
    public final static String schemaName = "declareserv";
    /* 数据库用户 */
    public final static String dbUsername = "root";
    /* 数据库密码 */
    public final static String dbPassword = "123456";
    /* 表名 */
    public final static String generateTable = "subsidy_detail"; // 为""会则更新整个数据库

    public final static String author = "李银";
        ...
        try {
            ...
            for (Entity entity : entityList) {
                ...
                if (entity.hasFsmInstance || entity.hasFsmLog) {
                    ...
                    generate(dtoPackage, "/src/main/java/", "J" + entity.className + ".java", "entitydto.ftl", entity, true);
...
//                    generate(serviceImplPackage, "/src/main/java/", entity.className + "ServiceImpl.java", "serviceImpl.ftl", entity, false);
