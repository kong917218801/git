...
public class MybatisEntity {
    ...
    public String IDaoPackageName;
    public String daoPackageName;
    public String servicePackageName;
    public String serviceImplPackageName;
    public String actionPackageName;
    public String abstractActionPackageName;
    public String className;
    public String fsmClassName;
    public String fsmInstanceClassName;
    ...
    public String remarksReporting;
    ...
    public boolean hasFsmLog = false;
    public boolean hasFsmInstance = false;
    ...
    public String getFsmInstanceClassName() {
        return fsmInstanceClassName;
    }

    public void setFsmInstanceClassName(String fsmInstanceClassName) {
        this.fsmInstanceClassName = fsmInstanceClassName;
    }
    ...
    public String getAbstractActionPackageName() {
        return abstractActionPackageName;
    }

    public void setAbstractActionPackageName(String abstractActionPackageName) {
        this.abstractActionPackageName = abstractActionPackageName;
    }
    ...
    public String getIDaoPackageName() {
        return IDaoPackageName;
    }

    public void setIDaoPackageName(String iDaoPackageName) {
        IDaoPackageName = iDaoPackageName;
    }
    ...
    public void setFsmClassName(String fsmClassName) {
    ...
    public boolean isHasFsmLog() {
        return hasFsmLog;
    }

    public void setHasFsmLog(boolean hasFsmLog) {
        this.hasFsmLog = hasFsmLog;
    }

    public boolean isHasFsmInstance() {
        return hasFsmInstance;
    }

    public void setHasFsmInstance(boolean hasFsmInstance) {
        this.hasFsmInstance = hasFsmInstance;
    }
